/*********************************************************************************************************//**
 * @file    CORDIC/CosSin_Interrupt/ht32f5xxxx_01_it.c
 * @version $Rev:: 8712         $
...
extern s32 cosOutput;
extern s32 sinOutput;
/*********************************************************************************************************//**
 * @brief   This function handles CORDIC Handler.
 * @retval  None
 ************************************************************************************************************/
void CORDIC_IRQHandler(void)
{
  extern volatile bool gCORDIC_ComputeDone;

  if (CORDIC_GetFlagStatus_RRDY() == SET)
  {
    cosOutput = CORDIC_ReadData();
    sinOutput = CORDIC_ReadData();

    gCORDIC_ComputeDone = TRUE;
  }
}
