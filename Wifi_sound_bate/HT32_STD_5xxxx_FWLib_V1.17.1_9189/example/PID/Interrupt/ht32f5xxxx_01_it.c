/*********************************************************************************************************//**
 * @file    PID/Interrupt/ht32f5xxxx_01_it.c
 * @version $Rev:: 8269         $
...
/*********************************************************************************************************//**
 * @brief   This function handles PID interrupt.
 * @retval  None
 ************************************************************************************************************/
void PID0_IRQHandler(void)
{
  extern volatile bool gIsPIDComputeDone;
  extern s16 gPIDout;

  if(PID_GetIntStatus(HT_PID0, PID_INT_CMP))
  {
    PID_ClearIntPendingBit(HT_PID0, PID_INT_CMP);

    // Get PIDout.
    gPIDout = PID_GetOutResult(HT_PID0);

    gIsPIDComputeDone = TRUE;
  }
}
