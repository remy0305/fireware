...
REM ============================================================================
gsar.exe -s"USE_STACK_ON_TOP    EQU     0" -r"USE_STACK_ON_TOP    EQU     1" MDK_ARMv5\startup_*.s -o
gsar.exe -s"USE_STACK_ON_TOP    EQU     0" -r"USE_STACK_ON_TOP    EQU     1" MDK_ARMv537\startup_*.s -o