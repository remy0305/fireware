...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 50441
STARTUP = startup_ht32f5xxxx_gcc_14
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F50441_SK
C_OPTION += -DUSE_HT32F50431_41
C_OPTION += -DUSE_MEM_HT32F50441
S_OPTION = --defsym USE_HT32_CHIP=30
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_14.c
