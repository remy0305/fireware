...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 52244
STARTUP = startup_ht32f5xxxx_gcc_17
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F52244_SK
C_OPTION += -DUSE_HT32F52234_44
C_OPTION += -DUSE_MEM_HT32F52244
S_OPTION = --defsym USE_HT32_CHIP=35
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_17.c
