...
char Humidity[]="25.5";
char Temperature[]="37.5";
char writeDataBuff[30];
...
int main(void)
{
	...
	clearBuff(writeDataBuff);
	//read Humidity from BM25S2021_1,for example Humidity = 25.5 %
	BMC81M001_arrayAdd(writeDataBuff,"field1=");
	BMC81M001_arrayAdd(writeDataBuff,Humidity);
	if(BMC81M001_writeByte(writeDataBuff,strlen(writeDataBuff),PUBLISHTOPIC)==true)
  {
   printf("Send Humidity data sucess\r\n");
  }
	clearBuff(writeDataBuff);
	//read Temperature from BM25S2021_1,for example Temperature = 37.5 %
	BMC81M001_arrayAdd(writeDataBuff,"field2=");
	BMC81M001_arrayAdd(writeDataBuff,Temperature);
	if(BMC81M001_writeByte(writeDataBuff,strlen(writeDataBuff),PUBLISHTOPIC)==true)
  {
   printf("Send Temperature data sucess\r\n");
  }
	while(1)
	{
