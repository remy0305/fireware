...
#define IS_USART_INT_LBD(x)           (x == USART_INT_LBD)
#else
#define IS_USART_INT_LBD(x)           (0)
#endif

#define IS_USART_INT(INT)             ((INT == USART_INT_RXDR) || (INT == USART_INT_TXDE)  || \
                                       (INT == USART_INT_TXC)  || (INT == USART_INT_OE)    || \
                                       (INT == USART_INT_PE)   || (INT == USART_INT_FE)    || \
                                       (INT == USART_INT_BI)   || (INT == USART_INT_RSADD) || \
                                       (INT == USART_INT_TOUT) || (INT == USART_INT_CTS)   || \
                                       (INT == USART_INT_CTS)  || IS_USART_INT_LBD(INT))
