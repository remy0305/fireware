/**
 @page CORDIC_CosSin_Polling

 @verbatim
 * @file    CORDIC/CosSin_Polling/readme.txt
 * @version V2.00
 * @date    2024-09-23
 * @brief   Description of CORDIC Polling CosSin example.
 @endverbatim

@par Example Description:

This example shows how to configure CORDIC as polling mode to calculate cosine and sine.
...
- CORDIC/CosSin_Polling/main.c                          Main program
- CORDIC/CosSin_Polling/ht32fxxxxx_nn_it.c              Interrupt handlers
