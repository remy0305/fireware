...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 53252
STARTUP = startup_ht32f5xxxx_gcc_15
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F53252_SK
C_OPTION += -DUSE_HT32F53242_52
C_OPTION += -DUSE_MEM_HT32F53252
S_OPTION = --defsym USE_HT32_CHIP=28
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_15.c
