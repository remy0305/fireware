/*********************************************************************************************************//**
 * @file    PGA/NonInvertingAdder/main.c
 * @version $Rev:: 8167         $
...
void PGA_Configuration(void)
{
  ...
  if(!PGA_InputCalibration(HTCFG_PGA_PORT, PGA_CALIBRATION_INPUT_NEGATIVE))
  {
    while(1){};
  }
  ...
  /* Set the Non-Inverting Adder Mode                                                                       */
  PGA_SetModeNonInvertingAdder(HTCFG_PGA_PORT, PGA_GAIN_6);
  /* Enable PGA                                                                                             */
