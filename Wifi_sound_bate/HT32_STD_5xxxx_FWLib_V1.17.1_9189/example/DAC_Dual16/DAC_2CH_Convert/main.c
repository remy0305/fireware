...
void DAC_Configuration(void)
{
  ...
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_1, AFIO_FUN_DAC0);     /* PC1 set as R-channel Output                    */
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_2, AFIO_FUN_DAC0);     /* PC2 set as L-channel Output                    */
