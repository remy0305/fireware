/**************************************************************************//**
 * @file    library/Device/Holtek/HT32F5xxxx/Source/system_ht32f5xxxx_19.c
...
//      <o8>   SystemCoreClock Source Divider
//                <0=> 1
//                <1=> 2
//                <2=> 4
//                <3=> 8
...
//      <q10>   Pre-fetch Buffer Enable
//                <i> Default pre-fetch buffer = ENABLE
//      <q11>   Branch cache Enable (HT32F52357/67, HT32F65230/40, MXTX6306, HT50F3200S Only)
...
#define HCLK_SRC          (1)     /*!< 0: PLL,      1: PLL,    3: HSI     7: LSI                            */
...
/*----------------------------------------------------------------------------------------------------------*/
/* PLL Out = (( HSI / (PLL_CLK_SRC_DIV + 1)) x PLL_NF2) / PLL_NO2                                           */
/*----------------------------------------------------------------------------------------------------------*/
...
void SystemInit(void)
{
  ...
  /* HSI power down                                                                                         */
#if ((HSI_ENABLE == 0) && (HCLK_SRC != 3) && (PLL_ENABLE == 0))
